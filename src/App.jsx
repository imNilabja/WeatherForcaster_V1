...
<div className='mx-auto my-auto my-20 w-fit min-h-[200px] flex-col justify-center gap-4 items-center md:text-xl text-md text-white font-bold md:block gap-y-3'>
